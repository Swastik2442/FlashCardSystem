...
export interface IFloatingDockItem {
  title: string;
  icon: React.ReactNode;
  onClick: () => void;
}

export const FloatingDock = ({ items, desktopClassName, mobileClassName }: { items: IFloatingDockItem[], desktopClassName?: string, mobileClassName?: string }) => {
  return (
    <>
...
const FloatingDockMobile = ({ items, className }: { items: IFloatingDockItem[], className?: string }) => {
...
const FloatingDockDesktop = ({ items, className, }: { items: IFloatingDockItem[], className?: string }) => {
